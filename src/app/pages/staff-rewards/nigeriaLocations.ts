export const lgasByState: Record<string, string[]> = {
  ...
  Adamawa: [
    "Demsa", "Fufure", "Ganye", "Gayuk", "Gombi", "Grie", "Hong", "Jada", "Larmurde", "Madagali",
  ...
  Ogun: [
    ...
    "Ipokia", "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside", "Remo North", "Sagamu",
  ],
  Ondo: [
...
export const nigerianStates: string[] = Object.keys(lgasByState);
